...
- [x] API service for programmatic access. 🚀 🚀 🚀 
...
SciPIP now provides a RESTful API service for programmatic access. This allows you to integrate SciPIP into your own applications or workflows.

### Installation

Install additional dependencies for the API service:
...
# 查看帮助
sh start_prod.sh help
```

The API service will be available at `http://localhost:8888` by default.
...
For detailed API documentation, please refer to [API_DOCUMENTATION.md](API_DOCUMENTATION.md) or visit `http://localhost:8888/docs` for interactive API documentation.
